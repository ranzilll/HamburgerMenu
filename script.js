...
document
  .querySelector(".sideinsdropdwn1a")
  .addEventListener("click", showlifeins);
...
document
  .querySelector(".sideilldropdown")
  .addEventListener("click", showillandinc);
...
document
  .querySelector(".sideilldropup")
  .addEventListener("click", hideillandinc);
...
document
  .querySelector(".sidecstdropdown")
  .addEventListener("click", showinscust);
...
document
  .querySelector(".sidependropdwn")
  .addEventListener("click", showsubmenu2);
...
document
  .querySelector(".sidependropdup")
  .addEventListener("click", hideubmenu2);
...
document
  .querySelector(".sideourpensdwn")
  .addEventListener("click", showourpens);
